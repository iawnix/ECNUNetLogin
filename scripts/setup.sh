...
passed at runtime via -u / --ask-password / --password-stdin, or via an
auth_ecnu run JSON file you control. See docs/config.md.
EOF
}
...
# Pass --username/-u at runtime, or use 'auth_ecnu run file.json'
# with a JSON file you keep private (mode 600).
